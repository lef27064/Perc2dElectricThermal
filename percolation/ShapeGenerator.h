...
#include "Edmonds_karp.h" // Defines the Edmonds-Karp algorithm for network flow problems
...
public:
	...
	double materialsShearModulus[maxComponents] = {};           // Shear moduli
	...
	double diffPaths[maxCases] = {};                // Difference in paths (e.g., between cases or iterations)
    ...
    double meanRVEShearModulus[maxCases] = {};
    double meanRVEPoissonRatio[maxCases] = {};
